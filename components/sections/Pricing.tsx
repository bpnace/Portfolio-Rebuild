      ...
      <div className="section-shell">
        ...
        <div className="mb-8 max-w-5xl space-y-5 md:mb-10">
          ...
          <p className="max-w-4xl text-base leading-7 text-muted md:text-lg md:leading-8">
            Vier Pakete decken die meisten Website-Projekte ab. Schlank starten,
            individueller aufbauen, Inhalte selbst pflegen oder ein kleines
            System daraus machen. Was darüber hinausgeht, kommt als
            Zusatzleistung dazu und nicht als versteckte Kosten.
          </p>
        </div>
